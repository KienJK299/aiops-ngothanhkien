...
def series_change(values: list) -> float:
...
def extract_features(incident: dict) -> dict:
    ...
    return {
        "incident_id": incident.get("incident_id", "").split("-2025")[0].split("-2026")[0],
        ...
        "affected_services": [s for s, _ in service_score.most_common() if s],
    }